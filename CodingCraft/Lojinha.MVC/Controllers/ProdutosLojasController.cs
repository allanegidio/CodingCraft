...
namespace Lojinha.MVC.Controllers
{
    public class ProdutosLojasController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProdutoLojaId,ProdutoId,LojaId,Estoque,Preco,DataModificacao,UsuarioModificacao,DataCriacao,UsuarioCriacao")] ProdutoLoja produtoLoja)
        {
            if (ModelState.IsValid)
            {
