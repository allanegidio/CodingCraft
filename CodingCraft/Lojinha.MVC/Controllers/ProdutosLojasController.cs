...
namespace Lojinha.MVC.Controllers
{
    public class ProdutosLojasController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProdutoLojaId,ProdutoId,LojaId,Estoque,DataModificacao,UsuarioModificacao,DataCriacao,UsuarioCriacao")] ProdutoLoja produtoLoja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProdutoLojaId,ProdutoId,LojaId,Estoque,DataModificacao,UsuarioModificacao,DataCriacao,UsuarioCriacao")] ProdutoLoja produtoLoja)
        {
            if (ModelState.IsValid)
            {
